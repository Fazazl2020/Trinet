...
class Config:
    ...
    model_type = 'best_composite'  # RECOMMENDED

    # Server paths - MODIFY THESE FOR YOUR SERVER
    checkpoint_dir = '/ghome/fewahab/My_5th_pap/Trinet-improved/ckpt'
    test_data_dir = '/gdata/fewahab/data/VoicebanK-demand-16K/test'
    enhanced_audio_dir = '/gdata/fewahab/My_5th_pap/Trinet-improved/enhanced_audio'
