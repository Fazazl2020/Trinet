...
class Config:
    ...
    resume_from_checkpoint = '/ghome/fewahab/My_5th_pap/Ab4-BSRNN/B3/saved_model'  # Path to checkpoint directory (or None to start fresh)
    load_checkpoint_type = 'last'  # 'best' or 'last' 
